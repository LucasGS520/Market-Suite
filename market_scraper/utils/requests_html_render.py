...
def fetch_rendered_html(url: str, timeout: int = 20, sleep: int = 1) -> str:
    ...
    Esta função é indicada para casos em que a página precisa executar JavaScript
    leve para exibir o conteúdo desejado, evitando o custo de um navegador
    completo como o Playwright.
    
    Args:
        url: Endereço da página que será coletada.
        timeout: Tempo máximo em segundos para cada etapa da requisição.
