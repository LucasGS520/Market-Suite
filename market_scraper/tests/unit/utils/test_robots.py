...
def test_is_allowed_returns_true_when_robot_permits(monkeypatch: pytest.MonkeyPatch) -> None:
    """Valida que URLs liberadas incrementam a métrica correta"""
...
def test_is_allowed_returns_false_when_robot_blocks(monkeypatch: pytest.MonkeyPatch) -> None:
...
def test_is_allowed_defaults_to_true_on_fetch_error(monkeypatch: pytest.MonkeyPatch) -> None:
