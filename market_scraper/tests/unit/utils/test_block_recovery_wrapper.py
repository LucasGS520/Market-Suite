...
def test_recover_html_if_blocked_encaminha_argumentos(monkeypatch):
    ...
    resultado = asyncio.run(recover_html_if_blocked("http://example.com", "403", session_id="sessao"))

    handle_mock.assert_awaited_once_with("403", session_id="sessao", url="http://example.com")
