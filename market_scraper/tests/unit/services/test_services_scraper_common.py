...
def _patch_common(monkeypatch):
    ...
    monkeypatch.setattr("scraper_app.services.services_scraper_common.RobotsTxtParser", lambda *a, **k: DummyRobots())
    monkeypatch.setattr("scraper_app.services.services_scraper_common.CircuitBreaker", lambda: DummyCB())
    monkeypatch.setattr("scraper_app.services.services_scraper_common.ThrottleManager.wait", lambda self, identifier=None, circuit_key="": None)
    monkeypatch.setattr("scraper_app.services.services_scraper_common.ThrottleManager.backoff", lambda self, attempt, circuit_key="": None)
    ...
    monkeypatch.setattr("scraper_app.services.services_scraper_common.parser.looks_like_product_page", lambda html: True)
    monkeypatch.setattr("scraper_app.services.services_scraper_common.parser.parse_product_details", lambda *a, **k: {
        "name": "prod",
...
def test_fetch_failure_unrecoverable_raises(monkeypatch):
    ...
    monkeypatch.setattr("scraper_app.services.services_scraper_common.fetch_html_playwright", fail_playwright)
...
def test_timeout_triggers_recovery(monkeypatch):
    ...
    monkeypatch.setattr("scraper_app.services.services_scraper_common.BlockRecoveryManager", lambda *a, **k: recovery)
    ...
    monkeypatch.setattr("scraper_app.services.services_scraper_common.fetch_html_playwright", timeout_fetch)
