...
def test_compare_prices_task_success(monkeypatch):
    ...
    monkeypatch.setattr("market_alert.tasks.compare_prices_tasks.send_notification_task.delay", fake_delay)

    monkeypatch.setattr("market_alert.tasks.compare_prices_tasks.run_price_comparison", fake_run_comparison)
