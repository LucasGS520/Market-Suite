...
para ``services_verification``. O retry é controlado pelo Celery aqui.
"""
...
from market_alert.core.retry_policies import VERIFICATION_RETRY
from market_alert.services.services_verification import (
    send_email_verification as _svc_send_email,
    send_phone_otp as _svc_send_phone_otp,
)
