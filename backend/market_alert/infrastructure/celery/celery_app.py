...
from market_alert.infrastructure.celery.config import (
    BEAT_SCHEDULE,
    TASK_MODULES,
    TASK_QUEUES,
    TASK_ROUTES,
)
from market_alert.infrastructure.task_loader import load_task_modules
from market_alert.infrastructure.logging_config import setup_worker_logging
from market_alert.infrastructure.worker_lifecycle import register_worker_signals
