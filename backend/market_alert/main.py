...
from market_alert.infrastructure.logging_config import setup_api_logging
...
from market_alert.infrastructure.routes.routes_health import router as health_router
