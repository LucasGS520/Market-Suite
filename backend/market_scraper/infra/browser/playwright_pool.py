...
from market_scraper.infra.limits.concurrency_limits import create_browser_semaphore

if TYPE_CHECKING:
    from playwright.async_api import Browser, BrowserContext, Page, Playwright


logger = get_scraper_logger("playwright_pool")
...
class PlaywrightPool:
    ...
    def __init__(self, *, max_concurrent: int = _MAX_CONCURRENT) -> None:
        self._semaphore = create_browser_semaphore(max_concurrent)
