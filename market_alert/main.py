...
#Rotas
from alert_app.routes.routes_users import router as users_router
from alert_app.routes.routes_admin import router as admin_router
from alert_app.routes.routes_monitored import router as monitored_router
from alert_app.routes.routes_competitors import router as competitor_router
from alert_app.routes.routes_monitoring_errors import router as monitoring_errors_router
from alert_app.routes.routes_notifications import router as notifications_router
from alert_app.routes.routes_comparisons import router as comparisons_router
from alert_app.routes.routes_alerts import router as alerts_router
from alert_app.routes.routes_health import router as health_router

#Rotas de auth
from alert_app.routes.auth.routes_login import router as login_router
from alert_app.routes.auth.routes_verify import router as verify_router
from alert_app.routes.auth.routes_reset_password import router as reset_router
from alert_app.routes.auth.routes_profile import router as profile_router
from alert_app.routes.auth.routes_refresh import router as refresh_router
from alert_app.routes.auth.routes_logout import router as logout_router
...
def create_app() -> FastAPI:
    ...
    from alert_app.utils.audit_exporter import app as audit_exporter_app
