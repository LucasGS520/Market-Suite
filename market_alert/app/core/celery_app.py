...
celery_app = Celery(
    ...
    include=[
        ...
        "app.tasks.compare_prices_tasks",
...
celery_app.conf.task_routes = {
    ...
    "app.tasks.scraper_tasks.collect_product_task": {
        "queue": "scraping", "routing_key": "scraping"
    },
    "app.tasks.scraper_tasks.collect_competitor_task": {
        "queue": "scraping", "routing_key": "scraping"
    },

    #Monitor tasks vão para fila "monitor"
    "app.tasks.monitor_tasks.recheck_monitored_products": {
        "queue": "monitor", "routing_key": "monitor"
    },
    "app.tasks.monitor_tasks.recheck_competitor_products": {
        "queue": "monitor", "routing_key": "monitor"
    }
}
...
celery_app.conf.beat_schedule = {
    ...
    "collect-celery-metrics-every-1min": {
        "task": "app.tasks.metrics_tasks.collect_celery_metrics",
