...
- Commits: mantenha mensagens claras no formato do tipo de mudança (ex.: `feat:`, `fix:`, `docs:`, `refactor:`, `test:`). Faça mudanças pequenas e coesas; referência arquivos/rotas afetadas. Evite criar branches sem necessidade ou renomear arquivos amplamente.
...
- Ao fim de cada modificação de código, no texto de atividades realizadas (resumo), traga a frase Utilizada para realizar o PR, seguindo o padrão anterior.
